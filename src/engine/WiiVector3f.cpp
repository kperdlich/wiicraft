...
{
    guVecAdd((guVector*)(&mVec), (guVector*)(&const_cast<Vector3f&>(other).mVec), (guVector*)(&mVec));
    return *this;
}

math::Vector3f& math::Vector3f::operator-=(const math::Vector3f& other)
{
    guVecSub((guVector*)(&mVec), (guVector*)(&const_cast<Vector3f&>(other).mVec), (guVector*)(&mVec));
    return *this;
}
...
{
    Vector3f vec;
    guVecSub((guVector*)(&mVec), (guVector*)(&const_cast<Vector3f&>(other).mVec), (guVector*)(&vec.mVec));
    return vec;
}
...
{
    Vector3f vec;
    guVecAdd((guVector*)(&mVec), (guVector*)(&const_cast<Vector3f&>(other).mVec), (guVector*)(&vec.mVec));
    return vec;
}
...
{
    return guVecDotProduct(
        reinterpret_cast<guVector*>(&const_cast<Vector3f&>(*this).mVec), reinterpret_cast<guVector*>(&const_cast<Vector3f&>(other).mVec));
}
...
math::Vector3f math::Vector3f::Cross(const math::Vector3f& other) const
{
    Vector3f cross;
    guVecCross(
        reinterpret_cast<guVector*>(&const_cast<Vector3f&>(*this).mVec),
