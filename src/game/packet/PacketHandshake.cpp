...
PacketHandshake::PacketHandshake() : Packet(PACKET_HANDSHAKE) {}

PacketHandshake::PacketHandshake(const std::string &playerName, const std::string &ip, uint16_t port) : Packet(PACKET_HANDSHAKE)
{
